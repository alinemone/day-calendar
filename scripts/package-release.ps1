...
$releaseNames = @('manifest.json','sidepanel.html','styles.css','app.js','calendar.js','recurrence.js','background.js','assets','README.md','VERIFICATION.md','screenshots','tests','scripts','package.json','package-lock.json')
